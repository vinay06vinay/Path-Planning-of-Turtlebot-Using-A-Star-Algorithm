...
def get_start_goal_inputs(obstacle_matrix):
    ...
    while True:
        ...
        if(goal_x <= 0 or goal_x >599):
            print("The X-coordinate of start node is out of the map. Please enter the coordinates again")
        elif(goal_y <= 0 and 200-goal_y > 199):
            print("The Y-coordinate of start node is out of the map. Please enter the coordinates again")
        elif(obstacle_matrix[(goal_x,200-goal_y)] == -1):
...
def astar(obstacle_matrix,start_x,start_y,start_theta,goal_x,goal_y,rpm_l,rpm_r):
    ...
    while(len(open_list)>0):
        ...
        #     goal_reached = True
        #     break
    return(child_parent_dict,goal_reached,closed_list,explored_dict,closed_list,node_list_dict)
# '''
...
# '''
def visualise(canvas,optimal_list,explored_dict,closed_list,child_parent_dict,node_list_dict,start):
...
def main():
    ...
    child_parent_dict,goal_reached,closed_list,explored_dict,closed_list,node_list_dict = astar(obstacle_matrix,start_x,start_y,start_theta,goal_x,goal_y,left_rpm,right_rpm)
    end_time = time.time()  
    ...
    visualise(canvas,optimal_list,explored_dict,closed_list,child_parent_dict,node_list_dict,(start_x,start_y,start_theta))
